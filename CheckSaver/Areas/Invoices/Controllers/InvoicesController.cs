...
using CheckSaver.Areas.Invoices.Models;
...
namespace CheckSaver.Areas.Invoices.Controllers
{
    ...
    {
        //readonly InvoicesWU _unitOfWork = new InvoicesWU(new InvoicesCS());
        ...
        //    }
        //    Invoice invoice = _unitOfWork.Invoices.GetById(id.Value);
        //    if (invoice == null)
        //    {
        //        return HttpNotFound();
        //    }
